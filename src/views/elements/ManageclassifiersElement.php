...
class ManageclassifiersElement extends Element
{
    ...
    public function render($data)
    {
        ...
        if (!empty($data['classifiers'])) {
            $data['TABLE_TITLE'] =
                tl('manageclassifiers_element_available_classifiers');
     ...
     */
     ...
     {
        ?>
        <h2><?=tl('manageclassifiers_element_manage_classifiers')?> <?=
        ...
        <div class="top-margin"><label for="class-label"><?=
            tl('manageclassifiers_element_classifier_name') ?></label>:
     ...
     */
     public function renderSearchForm($data)
     {
        ...
        $return_form_name = tl('manageclassifiers_element_element_create_form');
