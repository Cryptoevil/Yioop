...
class EditclassifierElement extends Element
{
    ...
    public function render($data)
    {
        ...
        <a href="<?=$admin_url ?>a=manageClassifiers&amp;<?=$context .
            C\CSRF_TOKEN.'='.$data[C\CSRF_TOKEN] ?>"><?=
            tl('editclassifier_element_back') ?></a>
        </div>
        ...
        <table>
            <tr>
            <th><?= tl('editclassifier_element_source') ?></th>
            <?= $td ?>
            ...
            <tr>
                <th><?= tl('editclassifier_element_keywords') ?></th><?php
                if ($_SERVER["MOBILE"]) { ?>
                    </tr><tr><?php
                }?>
