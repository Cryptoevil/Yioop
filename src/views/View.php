...
/* Used to control if update all the locales with translations
   This line just forces that we have the string view_locale_version
   in out list of things to translate, but otherwise does nothing.
   The value of the translation, if different then C\LOCALE_VERSION
   causes an upgrade of resource folders @see UpgradeFunctions::upgradeLocales
 */
tl('view_locale_version');
...
abstract class View
{
    ...
    public $layout = "";
    /**
     * The name of the type of controller object that is sending data to the
     * view
     * @var object
     */
    public $controller_object = null;
