...
class MachinestatusView extends View
{
    ...
    public function renderView($data)
    {
        ...
        if ($name_server_update) {
            e("<b>".tl('machinestatus_view_nameserver'));
            ?></b>|<a href="<?php e($update_mode_url); ?>"><?php
            e(tl('machinestatus_view_distributed'));?></a><?php
        } else {
            ?><a href="<?php e($update_mode_url); ?>"><?php
            e(tl('machinestatus_view_nameserver'));
            ?></a>|<b><?php
            e(tl('machinestatus_view_distributed'));?></b><?php
        }
        ?>]</div>
        <div class="box">
        <h3 class="no-margin"><?=
            tl('machinestatus_view_nameserver')
        ?></h3>
